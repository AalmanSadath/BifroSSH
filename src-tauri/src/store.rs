...
mod tests {
    ...
    fn nothing_readable_is_left_in_the_saved_file() {
        ...
        data.servers.push(crate::models::Server {
            ...
            auth_kind: None, proxy_jump: None, forward_agent: false, log_sessions: false, group: None, run_on_connect: None, hide_run_on_connect: true, notes: None, term: None, env: None, monitor: None, tags: Vec::new(),
        });
