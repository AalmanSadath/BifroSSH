...
//!
//! The BIP-39 English list, used under the MIT licence of the specification
//! it belongs to.
//!
//!   BIP-39, "Mnemonic code for generating deterministic keys",
//!   <https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki>
//!
//! Taken unmodified: 2048 words, all lowercase ASCII, three to eight letters,
//! and no two sharing their first four characters.
//!
//! Why a list at all: the passphrase generated from it may not be typed again
//! for years, and then only because something has already gone wrong. Short
//! common words survive being written on paper and read back. Random
//! characters do not, and one character lost in transcription here costs
//! everything.
//!
//! This list is built for that job. It exists so people can write down the
//! key to a wallet and still have it a decade later, which is the same
//! problem, and the unique four letter prefixes mean a word stays recoverable
//! even when the tail of it is illegible.
//!
...
pub static WORDS: [&str; 2048] = [
    ...
    "asset", "assist", "assume", "asthma", "athlete", "atom", "attack", "attend", "attitude",
    "attract", "auction", "audit", "august", "aunt", "author", "auto", "autumn", "average",
    "avocado", "avoid", "awake", "aware", "away", "awesome", "awful", "awkward", "axis",
    "baby", "bachelor", "bacon", "badge", "bag", "balance", "balcony", "ball", "bamboo",
    "banana", "banner", "bar", "barely", "bargain", "barrel", "base", "basic", "basket",
    "battle", "beach", "bean", "beauty", "because", "become", "beef", "before", "begin",
    ...
    "exile", "exist", "exit", "exotic", "expand", "expect", "expire", "explain", "expose",
    "express", "extend", "extra", "eye", "eyebrow", "fabric", "face", "faculty", "fade",
    ...
    "forum", "forward", "fossil", "foster", "found", "fox", "fragile", "frame", "frequent",
    ...
    "lake", "lamp", "language", "laptop", "large", "later", "latin", "laugh", "laundry",
    ...
    "protect", "proud", "provide", "public", "pudding", "pull", "pulp", "pulse", "pumpkin",
    "punch", "pupil", "puppy", "purchase", "purity", "purpose", "purse", "push", "put",
    ...
    "raw", "razor", "ready", "real", "reason", "rebel", "rebuild", "recall", "receive",
    ...
    "trim", "trip", "trophy", "trouble", "truck", "true", "truly", "trumpet", "trust",
    ...
    "urge", "usage", "use", "used", "useful", "useless", "usual", "utility", "vacant",
    "vacuum", "vague", "valid", "valley", "valve", "van", "vanish", "vapor", "various",
    "vast", "vault", "vehicle", "velvet", "vendor", "venture", "venue", "verb", "verify",
